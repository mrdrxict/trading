/*
  ...
  1. New Tables
    - `clients` - Store client information and registration details
    - `courses` - Course catalog with pricing and features
    ...
    - `trading_performance` - Student trading performance tracking
  ...
  3. Sample Data
    ...
    - Create realistic data for development and testing
*/
